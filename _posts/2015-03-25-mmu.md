...
One idea is to directly integrate a max count of processes with a max count of L2 tables for each process. The max count of processes can be evaluated empirically or estimated.
